...
import GenralSubmitButton from "../general/SubmitButtons";
            ...
            <Card>
                ...
                <CardContent>
                    <div className="flex flex-col gap-4">
                        ...
                        >
                            <GenralSubmitButton text="Login with Google" width="w-full" icon={<Google />} variant={"outline"} />
                        </form>
                        <form action={async () => {
                            "use server"
                            await signIn("github", {
                            ...
                            <GenralSubmitButton text="Login with Github" width="w-full" icon={<Github />} />
                        </form>
                    </div>
                </CardContent>
            </Card>
